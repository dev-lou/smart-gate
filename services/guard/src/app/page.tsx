  ...
  return (
    <div className="min-h-screen bg-surface-950 p-6">
        ...
        <div className="fixed inset-0 z-50 bg-black flex flex-col items-center justify-center">
          ...
          <div className="mt-6 text-center">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <button
                onClick={stopCamera}
                className="px-6 py-3 bg-surface-700 hover:bg-surface-600 text-white/70 rounded-xl transition-colors"
              >
                Cancel
              </button>
            </div>
      ...
      <header className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-white">🛡️ Guard Station</h1>
          <p className="text-surface-400 text-sm mt-1">Student enrollment & registration</p>
        </div>
          ...
          <div className="glass-card p-6">
            ...
            <div className="mt-4 p-4 bg-surface-800/50 rounded-xl">
              ...
              <ul className="space-y-1.5">
                ...
                <li className="flex items-center gap-2 text-xs text-surface-400">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary-500" />
                  Ensure <strong className="text-white/80">good lighting</strong> — avoid shadows on
                  face
                </li>
                <li className="flex items-center gap-2 text-xs text-surface-400">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary-500" />
                  Student should have a{" "}
                  <strong className="text-white/80">neutral expression</strong>
                </li>
                <li className="flex items-center gap-2 text-xs text-surface-400">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary-500" />
          ...
          <div className="glass-card p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="md:col-span-2">
                <label className="block text-sm text-surface-400 mb-1.5 font-medium">
                  Full Name *
                </label>
                <input
                  type="text"
